...
const installCommand = 'npm install -g sharely-cli'
      ...
      <main id="top">
        <section className="hero wrap">
          ...
          <div className="network-demo" aria-label="A Sharely link connecting a laptop to nearby devices">
            ...
            <div className="share-pill"><span className="pulse" /> sharely.local/share</div>
            <div className="signal signal--a" /><div className="signal signal--b" />
          </div>

          <div className="command-bar">
            <div className="command-label"><span>01</span> Install with npm</div>
            <code><i>$</i> npm install -g sharely-cli</code><CopyButton value="npm install -g sharely-cli" compact />
            <div className="command-result"><span>02</span><b>Ready to share</b><small>Run Sharely from any folder</small></div>
          </div>
        </section>
        ...
        <section className="why wrap" id="why">
          ...
          <div className="use-grid">
            ...
            <article className="use-card use-card--dark"><span className="card-kicker">NO FRICTION</span><div className="qr-art" aria-hidden="true"><span /><span /><span /><i /><i /><i /><i /><i /><i /><i /><i /><i /></div><h3>They just open a link</h3><p>A browser is all the other person needs.</p></article>
          </div>
        </section>

        <section className="how" id="how"><div className="wrap">
          <div className="section-intro section-intro--row"><div><span className="section-number">02 / HOW IT WORKS</span><h2>Share in three beats.</h2></div><p>Install once, run Sharely where your file lives, and send the link it gives you.</p></div>
          <ol className="steps">
            ...
            <li><span>3</span><div><b>Pass it on</b><p>Send the link or let someone scan the QR code. Stop it whenever you’re done.</p><code>sharely stop (SESSION NAME)</code></div></li>
          </ol>
        </div></section>
        ...
        <section className="install wrap" id="install"><div className="install-card">
          <span className="section-number">READY WHEN YOU ARE</span><h2>Keep your files close.<br />Share them faster.</h2><p>Sharely is free and built for macOS and Linux.</p>
          <div className="install-command"><code>{installCommand}</code><CopyButton value={installCommand} /></div><small>Sharely runs on macOS and Linux. Install it once, then use it from any folder.</small>
        </div></section>
      </main>
